...
Usage:
    ...
    python3 validators/download_datasheets.py --limit 10
    python3 validators/download_datasheets.py --project OpenMower
    python3 validators/download_datasheets.py --status
