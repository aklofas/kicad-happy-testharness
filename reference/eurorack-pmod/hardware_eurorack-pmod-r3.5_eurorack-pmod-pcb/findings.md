...
## FND-00000263: Eurorack FPGA PMOD r3.3 (118 components). All 14 detected RC filters are opamp feedback pairs — zero genuine standalone RC filters detected.

- **Status**: confirmed
- **Analyzer**: schematic
- **Source**: hardware_eurorack-pmod-r3.3_eurorack-pmod-pcb.kicad_sch.json
- **Created**: 2026-03-16

### Correct
- Power regulation correctly detected

### Incorrect
- All 14 RC filter entries are opamp feedback R+C pairs from TL074/TL072 compensator stages — no genuine standalone RC filters present
  (signal_analysis.rc_filters)
